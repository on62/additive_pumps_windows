...
FrmMain::FrmMain()
      : //Initialize gui elements
        ...
        lblRunStatus2("Pumps Inactive"),        //labelSentStatus displays Status of pumps
...
bool FrmMain::start_arduino_timeout()
{
    ...
    {        
        ...
        //serial connection to arduino
         m_ArduinoWorkerThread = new boost::thread([this]{m_ArduinoWorker.do_work(this);});
             return true;                   
    } 
    else
    {
...
{   
    ...
    {        
        ...
        //serial connection to scale
         m_ScaleWorkerThread = new boost::thread([this]{m_ScaleWorker.do_work(this);});
             return true;                   
    } 
    else
    {
