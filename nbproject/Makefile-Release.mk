...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/additive_pumps_windows.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/additive_pumps_windows ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/EditRecipeWindow.o: EditRecipeWindow.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EditRecipeWindow.o EditRecipeWindow.cpp
...
${OBJECTDIR}/ScaleWorker.o: ScaleWorker.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ScaleWorker.o ScaleWorker.cpp
